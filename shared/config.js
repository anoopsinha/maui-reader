var config = {
  tabData: {
    tab1: [
      '1 This app demonstrates how to use client-side packages to configure element positioning and present different UI themes.',
    ...
    tab2: [
      '2 The "default" package contains the core of the app. It is represented by the directory /client/default.',
    ...
    tab3: [
      '3 The "bottom_nav" package contains an override prefs.js which positions the tabs at the bottom of the app.',
    ...
    tab4: [
      '4 The content for the tabs in this app are configured in /shared/config.js',
